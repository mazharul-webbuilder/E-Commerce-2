            ...
            <div class="container">
                <div class="header-left">
                    ...
                    <a href="{{route('home')}}" class="logo">
                        <img src="{{asset('/')}}front/assets/images/logo.png" alt="Molla Logo" width="105" height="25">
                    </a>
                                ...
                                <div class="megamenu demo">
                                    <div class="menu-col">
                                        ...
                                        <div class="demo-list">
                                            <div class="demo-item">
                                                <a href="index-1.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/1.jpg);"></span>
                                            ...
                                            <div class="demo-item">
                                                <a href="index-2.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/2.jpg);"></span>
                                            ...
                                            <div class="demo-item">
                                                <a href="index-3.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/3.jpg);"></span>
                                            ...
                                            <div class="demo-item">
                                                <a href="index-4.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/4.jpg);"></span>
                                            ...
                                            <div class="demo-item">
                                                <a href="index-5.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/5.jpg);"></span>
                                            ...
                                            <div class="demo-item">
                                                <a href="index-6.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/6.jpg);"></span>
                                            ...
                                            <div class="demo-item">
                                                <a href="index-7.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/7.jpg);"></span>
                                            ...
                                            <div class="demo-item">
                                                <a href="index-8.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/8.jpg);"></span>
                                            ...
                                            <div class="demo-item">
                                                <a href="index-9.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/9.jpg);"></span>
                                            ...
                                            <div class="demo-item">
                                                <a href="index-10.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/10.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-11.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/11.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-12.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/12.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-13.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/13.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-14.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/14.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-15.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/15.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-16.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/16.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-17.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/17.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-18.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/18.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-19.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/19.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-20.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/20.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-21.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/21.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-22.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/22.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-23.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/23.jpg);"></span>
                                            ...
                                            <div class="demo-item hidden">
                                                <a href="index-24.html">
                                                    <span class="demo-bg" style="background-image: url({{asset('/')}}front/assets/images/menu/demos/24.jpg);"></span>
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-3">
                        <div class="widget widget-about">
                            <img src="{{asset('/')}}front/assets/images/logo.png" class="footer-logo" alt="Footer Logo" width="105" height="25">
